 ...
 * RESULTS
 */
 //div[@class ='map-list list list-group display-flex flex-direction-column OSFillParent']/div[@data-container]
function getListingItems(page: Page): Locator {
  return page.locator('map-list list list-group display-flex flex-direction-column OSFillParent > div  > diiv.list-item-mobile map-list-item ');
}
